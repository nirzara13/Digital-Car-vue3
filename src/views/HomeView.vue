<!-- <template>
  <div class="bg-0A1128 text-FEFCFB flex flex-col min-vh-100">
    <TheHeader />
    <main class="flex-grow-1 pt-5 mt-5">
      <div class="container py-5">
        ...
        <section class="row">
          <div class="col-md-4">
            <div class="card shadow-sm mb-4 bg-034078 text-FEFCFB">
              <div class="card-body">
                <h3 class="card-title h4 text-1282A2">Easy to Use</h3>
                <p class="card-text">Our platform is designed to be user-friendly and intuitive.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card shadow-sm mb-4 bg-034078 text-FEFCFB">
              <div class="card-body">
                <h3 class="card-title h4 text-1282A2">Real-Time Results</h3>
                <p class="card-text">Get instant feedback and analyze survey results in real-time.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card shadow-sm mb-4 bg-034078 text-FEFCFB">
              <div class="card-body">
                <h3 class="card-title h4 text-1282A2">Customizable Surveys</h3>
                <p class="card-text">Create surveys that suit your specific needs and preferences.</p>
              </div>
            </div>
          </div>
        </section>
...
.text-1282A2 {
  color: #286779;  /* Couleur spécifiée */
}
.bg-034078 {
    ...
    <main class="flex-grow-1 pt-5 mt-5">
      <div class="container py-5 text-center">
        ...
        <section class="carousel-container mb-5">
          <div id="surveyCarousel" class="carousel slide" data-bs-ride="carousel">
